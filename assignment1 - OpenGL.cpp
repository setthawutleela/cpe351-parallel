...
void magic_dots(void) {
    ...
    if (timeframe < MAX_TIMEFRAME) {
        ...
        if(timeframe != MAX_TIMEFRAME)
            snprintf(title, 100, "[Time Frame: %d] Heat Transfer with OpenGL (60070503466 & 60070503482)", timeframe);
        else
            snprintf(title, 100, "[Time Frame: %d Completed!] Heat Transfer with OpenGL (60070503466 & 60070503482)", timeframe);
